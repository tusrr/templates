...
$.fn.zabuto_calendar = function (b) {
  ...
  this.each(function () {
    ...
    function l() {
      ...
      $legendObj = g(j);
      var z = $(
        '<div class="zabuto_calendar" id="' + j.attr("id") + '"></div>'
      );
      z.append($tableObj);
      z.append($legendObj);
      j.append(z);
                ...
                case "text":
                  if (F !== "") {
                    ...
                    if ("badge" in G) {
                      ...
                      D =
                        '<span class="badge ' + H + '">' + G.badge + "</span> ";
                    }
                    y.append(
                      '<span class="legend-' + G.type + '">' + D + F + "</span>"
                    );
                  }
                  break;
                case "block":
    ...
    function h(B, H, G, J) {
      ...
      var A = $(
        '<h4 class="modal-title" id="' + B + '_modal_title">' + H + "</h4>"
      );
      var K = $('<div class="modal-header"></div>');
      K.append(I);
      K.append(A);
      var F = $(
        '<div class="modal-body" id="' + B + '_modal_body">' + G + "</div>"
      );
    ...
    function u(z, y, C) {
      ...
      $.ajax({ type: "GET", url: B.url, data: A, dataType: "json" }).done(
        function (D) {
          var E = [];
          $.each(D, function (G, F) {
            E.push(D[G]);
