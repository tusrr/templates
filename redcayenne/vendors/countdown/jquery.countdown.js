  ...
  $.extend(CountDown.prototype, {
    ...
    parseDateTime: function (str) {
      ...
      if (timeArray) {
        ...
        var offset = timeArray[8]
          ? timeArray[8].match(/^([\+\-])?(\d{2}):?(\d{2})$/)
          : undefined;
    ...
    doCountDown: function () {
      ...
      this.displayRemainingTime({
        ss:
          ss < 10
            ? (this.options.with_ss_leading_zero ? "0" : " ") + ss.toString()
            : ss.toString(),
        mm:
          mm < 10
            ? (this.options.with_mm_leading_zero ? "0" : " ") + mm.toString()
            : mm.toString(),
        hh:
          hh < 10
            ? (this.options.with_hh_leading_zero ? "0" : " ") + hh.toString()
            : hh.toString(),
        dd: dd.toString(),
      });
